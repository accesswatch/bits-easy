...
## 1. Executive Summary
This PRD defines a full roadmap to deliver a delightful, magical, and accessibility-first NVDA feature suite that achieves practical parity with the Leasey experience and exceeds it in selected workflows through AI assistance, adaptive interaction design, and stronger cross-workflow continuity.
...
2. Achieve Full or Partial parity coverage for all major Leasey modules.
...
## 8. Leasey to NVDA Parity Matrix (Full Mapping by Module)
This matrix maps Leasey module-level capabilities to planned NVDA equivalents and status.

| Leasey Capability Group | Proposed Equivalent | Status | Confidence | Priority |
|---|---|---|---|---|
| LeaseySelect | SnapSpan | Full Planned | Very High | P0 |
| LeaseyClips | PocketClips | Full Planned | Very High | P0 |
| Clipboard Append Features | MergeBoard | Full Planned | Very High | P0 |
| LeaseyPoints | Waymarks | Full Planned | High | P1 |
| LeaseyAlerts | Signal triggers in Trailback and Beacon Search | Partial Planned | Medium High | P1 |
| LeaseyStickyNotes | SignalNotes | Full Planned | High | P1 |
| LeaseyNotes | ThoughtDock | Full Planned | High | P1 |
| LeaseyVirtualNotes | ThoughtDock Side Panel Mode | Full Planned | High | P1 |
| External notes interoperability | Notebook Bridge for Joplin | Partial Planned | Medium High | P2 |
| LeaseyConnect | Contact Orbit inside RelayDesk | Partial Planned | Medium High | P1 |
| LeaseyWord Utilities | Spellforge Compose tools | Partial Planned | High | P1 |
| LeaseySearch | Beacon Search | Partial Planned | Medium High | P1 |
...
| LeaseyClock | Time Lantern | Full Planned | High | P2 |
| LeaseyDiary | Day Compass | Full Planned | High | P2 |
...
Not every Leasey feature is mapped at full feature-level parity yet.

Current coverage snapshot:
1. Module-level parity mapping: Broad coverage is present across core Leasey areas.
...
### 8.2 Leasey 11.5 Addendum Mapping (Summer 2026)
The following upcoming Leasey 11.5 capabilities are now added to this PRD roadmap.

| Leasey 11.5 Capability | Proposed Equivalent | Status | Confidence | Priority |
|---|---|---|---|---|
| Leasey Media Centre unified model | Media Nexus shell with Skywave, StoryStream, local audio, playlists, and sound control | Partial Planned | Medium | P3 |
| Leasey Media Player global and braille-aware controls | Media Core player layer with speech and braille parity | Partial Planned | Medium | P3 |
...
| Redesigned LeaseyCuts with categories and presets | PocketClips and PathPilot shortcut catalog | Full Planned | High | P0-P1 |
| Leasey Database Manager | DataForge database builder | Full Planned | Medium High | P1 |
...
| Leasey File Manager | PathPilot file operations shell | Partial Planned | High | P1 |
| Start Menu and Main Menu curation | LaunchPad and QuickLane launch curation | Full Planned | High | P1 |
| LeaseyDiary plus tasks and ICS sync | Day Compass and Task Orbit with ICS bridge | Partial Planned | High | P2 |
| Leasey Spell Check clipboard workflow | Spellforge Spell clipboard pass | Full Planned | High | P2 |
| LeaseySocial Mastodon and Bluesky client | Social Orbit multi-account timeline client | Partial Planned | Medium | P2 |
...
This section is a comprehensive inventory based on the Leasey help index and related update material reviewed for this PRD cycle. Each chapter or feature family is mapped and assigned a parity intent and magical differentiation path.
...
| Leasey Chapter or Feature Family | Proposed Equivalent | Status | Magical Differentiation Path |
|---|---|---|---|
...
| Getting Started Leasey Basic | Guided Basics Mode | Full Planned | Task cards with instant repeat and confidence score |
| Getting Started Leasey Advanced | Guided Advanced Mode | Full Planned | Intent trainer that teaches shortcuts from real usage patterns |
| Working With Sounds | Earcon Studio | Full Planned | Sound personalization with context-aware density controls |
| Leasey Word | Compose Studio | Full Planned | Writing flow mode with context hints and fewer interruptions |
...
| LeaseyConnect | Contact Orbit | Partial Planned | Relationship graph between contacts, channels, and recent actions |
...
| LeaseySearch | Beacon Search | Partial Planned | Unified retrieval lens with source confidence and resume point memory |
| Leasey Sports and Games | ScorePulse | Partial Planned | Smart monitor profiles by sport urgency and preferred verbosity |
| LeaseyDiary | Day Compass | Full Planned | Timeline lens that merges appointments, tasks, and reminders |
| LeaseySelect | SnapSpan | Full Planned | Intent-select actions that infer copy, summarize, or transform pathways |
| LeaseyTexts | TextVault | Full Planned | Semantic templates and variable slots for reusable text blocks |
| LeaseyClips | PocketClips | Full Planned | Auto-labeled clips from context and source tags |
| LeaseyCuts | PathPilot shortcuts | Full Planned | Dynamic collections by workflow and current app context |
| LeaseyNotes | ThoughtDock | Full Planned | Knowledge-link suggestions between notes and tasks |
| Leasey Virtual Notes | ThoughtDock Side Panel | Full Planned | Persistent side-reading with exact resume line memory |
| LeaseyAlerts | SignalNotes alerts | Partial Planned | Trigger confidence and intelligent false-positive suppression |
| LeaseyPoints | Waymarks | Full Planned | Multi-mode anchors with reliability scoring and fallback targeting |
| LeaseyStickyNotes | SignalNotes sticky annotations | Full Planned | Contextual reminders with optional quiet mode and replay |
...
| LeaseyClock | Time Lantern | Full Planned | Braille synchronized precision clock and monitor presets |
| LeaseyTags | TagFlow | Full Planned | Cross-folder and cross-mailbox tag sessions with safe batch actions |
| Progress Indicators | ProgressSense | Full Planned | Predictive completion feedback and stall detection guidance |
| Leasey Audio | AudioCore | Partial Planned | Unified playback control with context-preserving resume |
| Leasey Radio | Skywave | Partial Planned | Ranked lower priority with smart station and record automation |
...
| Leasey Custom Help | Help Weave | Full Planned | Smart local playbook with searchable procedures and linkbacks |
| Leasey Custom Web Text | Web Notes Weave | Full Planned | Domain or page memory overlays with quick compare |
...
| Leasey Games | Game Hub | Pending Detail | Separate optional module with progression and accessibility coaching |
...
| Leasey Start Menu | LaunchPad | Full Planned | Context-aware app launcher with dynamic pinning |
...
| Leasey 11.5 Media Centre | Media Nexus | Partial Planned | Unified radio, podcast, audio, playlist, and sound control shell |
| Leasey 11.5 Notes redesign | ThoughtDock Advanced and Simple | Full Planned | Dual-mode notes with restore points and relationship graph |
| Leasey 11.5 Cuts redesign | PathPilot advanced cuts | Full Planned | Category, filter, and preset engine with strong import support |
| Leasey 11.5 Database | DataForge | Full Planned | Accessible schema designer and records grid with validation and export |
| Leasey 11.5 File Manager | PathPilot file shell | Partial Planned | Fast file operations with tagged sets and safe bulk workflows |
| Leasey 11.5 Social client | Social Orbit | Partial Planned | Timeline-focused, field-configurable social workspace with braille flash |

## 19. Feature Completeness Statement
Answer to the direct question, "is every Leasey feature mapped":
...
1. Full feature-family mapping coverage for the Leasey help index and reviewed 11.5 additions.
...
|---|---|---|---|
| E01 | Selection and Clip Intelligence | LeaseySelect, LeaseyClips, clipboard append, LeaseyTexts abbreviations | v1 |
| E02 | Anchors, Alerts, and Context Return | LeaseyPoints, LeaseyAlerts, Sticky notes context behaviors | v1-v2 |
| E03 | Markdown and HTML Authoring | Markdown, HTML Assistant, text conversion workflows | v1-v2 |
| E04 | Notes and Knowledge Workspace | LeaseyNotes, Virtual Notes, Custom Help, Custom Web Text | v1-v2 |
| E05 | Shortcuts and File Navigation | LeaseyCuts, Start Menu, Mapping drives, file property helpers | v1-v2 |
| E06 | Tagging and Table Capture | LeaseyTags, Table Capture | v1-v2 |
| E07 | Time, Diary, and Task Flows | LeaseyClock, LeaseyDiary, calendar integration, tasks | v2-v3 |
| E08 | Communication and Social Adapters | LeaseyConnect, email workflows, WhatsApp, X, Mastodon, Bluesky | v2-v3 |
| E09 | Search and Retrieval Layer | LeaseySearch, web workflow helpers, old reader and rss patterns | v2-v4 |
| E10 | Database and Structured Records | Leasey Database and Jamal bridge | v2-v4 |
...
Decomposition is complete for all mapped Leasey families and reviewed update features, including:
...
This PRD is now complete at strategic and decomposition levelsand ready for implementation planning and sprint execution.
