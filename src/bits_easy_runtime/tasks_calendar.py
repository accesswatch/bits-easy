...
_logger = get_logger("bits_easy.tasks_calendar")
...
class TaskIcsBridge:
    ...
    def _load(self) -> None:
        ...
        try:
            ...
            _logger.exception("BITS-EASY: loading tasks at %s failed", self._storage_path)
            return
    ...
    def export_ics(self, out_path: Path | str) -> RuntimeResult:
        ...
        lines = [
            "BEGIN:VCALENDAR",
            "VERSION:2.0",
            "PRODID:-//BITS-EASY//Tasks Bridge//EN",
        ]
