...
_logger = get_logger("bits_easy.clip_library")
...
class ClipLibraryStore:
    def __init__(self, runtime: BitsEasyRuntime, storage_path: Path | str):
    ...
    def _load(self) -> None:
        ...
        try:
            ...
            _logger.exception("BITS-EASY: loading clip library at %s failed", self.storage_path)
            self._clips = {}
            self._folders = {}
