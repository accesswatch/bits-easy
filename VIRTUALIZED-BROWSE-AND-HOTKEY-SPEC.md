...
1. Tier 1 commands: top 20 frequency and low ambiguity actions.
...
| Profile | Behavior |
| --- | --- |
| Beginner | Announces command name and result summary after execution |
| Balanced | Announces concise status and confidence only |
| Expert | Minimal status output and fastest repeat execution |
